...
namespace LY.Redis.ExchangeRedis
{
    /// <summary>
    ...
    public class ExchangeRedisHelper
    {
        ...
        private string GetRedisHost()
        {
            ...
            //var container = IocRegisterHelper<IConfigContract>.GetIocContainer;
            //var plugin = container.GetAllInstances<IConfigContract>().FirstOrDefault();
            //if (plugin == null)
            //{
                redisHost = ConfigurationManager.AppSettings["RedisHostList"].ToString();
            //}
            //else
            //{
            //    redisHost = plugin.GetAppSettingValue<string>("RedisHostList");
            //}
        ...
        public bool Set(string key, string value, int expireSeconds = 0)
        {
            ...
            {
                return db.StringSet(key, value, TimeSpan.FromSeconds(_defaultExpireSeconds));
            }
        }
        ...
        public bool SetToBinary<T>(string key, T obj, int expireSeconds = 0)
        {
            ...
            {
                return db.StringSet(key, byteValue, TimeSpan.FromSeconds(_defaultExpireSeconds));
            }
        }
        ...
        //{
        //    return string.Format("{0}{1}", type.ToString("G"), key);
        //}
        #endregion
